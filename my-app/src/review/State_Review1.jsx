...
const StateReview1 = () => {
  ...
  //배열 사용 연습
  const tempList = ['aaaa', 'bbbb', 'cccc', 'dddd'];
   ...
   * @param e : 이벤트 객체(발생한 이벤트 관련 정보가 담겨있는 객체)
   */
  const inputStringH = (e) => {
  ...
  /**
   *  엔터 처리
   * @param e : 이벤트 객체 (어떤 키가 입력되엇는지 포함) 
   */
  const enterH = (e) => { // 엔터 키가 입력된 경우
  ...
  return(
    <div>
      ...
      <ul>
        {/* <li>문자열 입력 후 엔터입력 시 ul 태그에 누적</li>
        ...
        {/* strList에 저장된 값을 이용해 li 태그를 만들어 출력 */}
...
/* 
  * 전개 연산자 (...)
  ...
  - 배열 : 요소 추가, 복사, 배열 병합
  - 객체 : 복사, 병삽, 속성 덮어쓰기(객체 값 중 일부만 변경)
